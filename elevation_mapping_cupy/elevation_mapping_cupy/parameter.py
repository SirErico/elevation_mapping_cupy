...
class Parameter(Serializable):
    ...
    enable_edge_sharpen: bool = False  # enable edge sharpening
    enable_drift_compensation: bool = False  # enable drift compensation
    enable_visibility_cleanup: bool = False  # enable visibility cleanup
    enable_overlap_clearance: bool = False  # enable overlap clearance
